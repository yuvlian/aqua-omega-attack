...
get_struct_info :: proc (info: ^reflect.Type_Info, ctx: string) -> reflect.Type_Info_Struct {
...
apply_copy_plan :: proc (buffer: []u8, plan: Layout_Plan, $T: typeid) -> T {
    out: T
    dst := ([^]u8)(transmute(^u8)&out)[:size_of(T)]
